        ...
        <div className='bg-neutral-200 dark:bg-slate-900 px-5 sm:px-10 md:px-15 lg:px-25 xl:px-30 font-segoeUI transition-all duration-300'>
            <section id='stack' className='min-h-screen py-20'>
                <div className='dark:text-white flex flex-col items-center justify-center'>
                    ...
                    <div className='flex flex-wrap justify-center items-center gap-12 sm:gap-10 md:gap-15 lg:gap-20 px-4 sm:px-8 md:px-12 lg:px-32'>
                        <StackGroup title="Programming Languages" stack={['js','cpp','python']}/>
                        <StackGroup title="Frontend" stack={['react','tailwind','redux','antd','js','framer','html','css','chartjs']}/>
                        <StackGroup title="Server" stack={['express','node','fastapi','flask','socket']}/>
                        <StackGroup title="Databases" stack={['mongodb','postgres','mysql','redis']}/>
                        <StackGroup title="Cloud" stack={['aws','heroku','vercel','netlify']}/>
                        <StackGroup title="Machine Learning" stack={['tensorflow','sklearn','opencv','python']}/>
